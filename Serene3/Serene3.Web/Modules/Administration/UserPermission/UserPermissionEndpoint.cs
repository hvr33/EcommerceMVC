using MyRepository = Serene3.Administration.Repositories.UserPermissionRepository;
using MyRow = Serene3.Administration.UserPermissionRow;

namespace Serene3.Administration.Endpoints;
